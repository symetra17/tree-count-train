...
TF_LIB=$(python2 -c 'import tensorflow as tf; print(tf.sysconfig.get_lib())')
...
if [ -d "$CUDA_PATH" ]; then
echo $TF_INC
echo $TF_INC/external/nsync/public
	...
	g++ -std=c++11 -shared -o roi_pooling.so roi_pooling_op.cc \
		roi_pooling_op.cu.o -I$TF_INC/external/nsync/public -I $TF_INC  -D GOOGLE_CUDA=1 -fPIC $CXXFLAGS -D_GLIBCXX_USE_CXX11_ABI=0\
